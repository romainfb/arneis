...
const BasketModal = () => {
  ...
  if (!isMounted) {
    return null; // ou un placeholder/loading state
  }
          ...
          >
            ...
            <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-6">
              <div className="flex items-center justify-between w-full mb-4">
                <h2 className="font-bold text-2xl leading-9 text-primary">
                  {item.name}
                </h2>
                <button
        ...
        {cart.length > 0 ? (
          <>
            ...
            <div className="max-lg:max-w-lg max-lg:mx-auto">
              <Link href="/basket">
                <button className="rounded-full py-4 px-6 bg-primary text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-primary-dark">
                  Voir mon panier
                </button>
              </Link>
            </div>
